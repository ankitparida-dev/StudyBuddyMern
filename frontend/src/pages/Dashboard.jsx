        ...
        <main className="main-content">
          ...
          >
            <SubjectsSection 
              examType={activeExam} 
              subjectStats={{
                physics: combinedStats?.physics || { accuracy: 0, topicsCompleted: 0 },
                chemistry: combinedStats?.chemistry || { accuracy: 0, topicsCompleted: 0 },
                math: combinedStats?.math || { accuracy: 0, topicsCompleted: 0 },
                biology: combinedStats?.biology || { accuracy: 0, topicsCompleted: 0 }
              }}
            />
          </section>
          ...
          >
            <StreaksSection 
              examType={activeExam} 
              streaks={{
                current: combinedStats?.streak || 0,
                longest: combinedStats?.longestStreak || 0,
